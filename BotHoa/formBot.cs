...
namespace BotBanHang
{
    ...
    public partial class formBot : Form
    {
        ...
        //HoiDataBase HoiData;
        //6052997336
        public long chatId = 5601581161; // Mk fix trước 1 cái chat id là tài khuản của mk! -> cái này liên quan đến việc nhúng ở bên app
        ...
        public formBot()
        {
            ...
            string token = "6107553833:AAGzGuPIFVEVoPh88zCgGtiVL0cQfcyKBPY";
